...
test.describe('[US05] Asignación de permisos | Asignar permisos a los empleados', () => {
    test('[US-05 | TC-01] | Validar asignar permisos de administrador un empleado exitosamente', async ({ employeePage, adminPage }) => {
        ...
        await test.step('Y se agrega un nuevo rol de usuario', async () => {
            await adminPage.addNewUserRole('XristophAdmin', 'Admin', 'Xristoph Pereh', 'Enabled', 'admin1234');
        });
