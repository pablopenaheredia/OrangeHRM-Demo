...
test.describe('[US02] Gestión de empleados | Agregar y validar empleados', () => {
    ...
    test('Escenario 6 | Validar error al ingresar un empleado con numeros o simbolos para el sector nombre y apellido, y letras para el sector ID.', async ({ employeePage }) => {
